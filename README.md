...
## Вывод
Можно заметить, что при относительно небольших размерах матриц (200, 400, 600) скорость между 1, 2 и 4 потоками почти не отличается, но как только мы переходим к уже весомым размерам матриц (1000, 1500 и т.д) на 2 и 4 потоках скорость вычисления гораздо меньше, чем на одном. Например, при размере матрицы 2000 скорость 2 потоков в 1,7 раз больше чем на 1 потоке.
